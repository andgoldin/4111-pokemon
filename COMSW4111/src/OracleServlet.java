...
public class OracleServlet extends HttpServlet { 
	...
	private static final String connect_string = "jdbc:oracle:thin:yg2346/vulpix123@//w4111b.cs.columbia.edu:1521/ADB"; 
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		try { 
			...
			ResultSet rset = stmt.executeQuery("select SPRITEURL from POKEMON"); 
			...
			pw.println("<body><BR>"); 
			while (rset.next()) { 
				pw.println ("<img src=" + rset.getString("spriteurl") + " /><BR>"); 
			}
